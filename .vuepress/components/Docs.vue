                            ...
                            <b-card no-body
                                ...
                                <b-list-group flush>
                                    <b-list-group-item class="py-4">
                                        <b-link :href="`https://github.com/hikecoder/erc20-generator/blob/v${token.version}/dist/${contracts.token.contractName}.dist.sol`"
                                                target="_blank">
                                            <b-img :src="`https://img.shields.io/badge/version-${token.version}-blue`"></b-img>
                                        </b-link>
                                        <b-link href="https://github.com/hikecoder/erc20-generator/actions" target="_blank">
                                            <b-img src="https://github.com/hikecoder/erc20-generator/workflows/CI/badge.svg?branch=master"></b-img>
                                        </b-link>
                                        ...
                                        <b-link href="https://github.com/hikecoder/erc20-generator/blob/master/LICENSE" target="_blank">
  ...
  export default {
    ...
    computed: {
      controlFlow: function () {
        return `https://github.com/hikecoder/erc20-generator/blob/v${this.token.version}/analysis/control-flow/${this.contracts.token.contractName}.png`;
      },
      inheritanceTree: function () {
        return `https://github.com/hikecoder/erc20-generator/blob/v${this.token.version}/analysis/inheritance-tree/${this.contracts.token.contractName}.png`;
      },
      uml: function () {
        return `https://github.com/hikecoder/erc20-generator/blob/v${this.token.version}/analysis/uml/${this.contracts.token.contractName}.svg`;
      },
    },
    mounted () {
      this.initDapp();
