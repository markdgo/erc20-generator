<template>
    <b-row>
        <b-col lg="10" offset-lg="1" class="mt-4 p-0">
            <b-card bg-variant="light" v-if="!loading" title="Token documentation">
                <b-card-text>
                    ...
                    <ul>
                        ...
                        <li><b>Mintable Token</b>: you will be able to generate tokens by minting them. Only people (or
                            smart contract) with
