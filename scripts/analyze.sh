...
for contract in "SimpleERC20" "StandardERC20" "PausableERC20" "BurnableERC20" "MintableERC20" "CommonERC20" "UnlimitedERC20" "AmazingERC20" "PowerfulERC20" "ServiceReceiver"
do
